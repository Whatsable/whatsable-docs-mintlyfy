...
description: 'Receive incoming and outgoing WhatsApp messages via webhooks — including replies typed in the WhatsApp Business app. Payload fields cover direction, sending system, and which teammate sent the message.'
icon: 'inbox'
keywords: ['webhook', 'outgoing messages', 'incoming messages', 'send_by', 'was_message_by_human', 'incoming_message', 'WhatsApp Business app', 'coexistence', 'n8n']
---
...
Use this to trigger automations, sync CRMs, and log full conversation history — not only inbound chat.
