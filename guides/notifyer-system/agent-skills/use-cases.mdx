...
`--outgoing` is required for phone-app and inbox replies. Payload fields: `incoming_message`, `send_by`, `was_message_by_human`. See [Message webhooks](/guides/notifyer-system/api/incoming-message) and [coexistence](/guides/notifyer-system/embedding-process#whatsapp-coexistence).
