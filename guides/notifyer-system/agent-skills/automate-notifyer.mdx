...
description: "Automation scripts for templates, AI bots, broadcasts, analytics, and webhooks — including outgoing WhatsApp Business app messages (coexistence)."
icon: "gear"
keywords: ["webhooks", "outgoing", "send_by", "coexistence"]
---
