...
<br />
    <Frame caption="Configuring message">
      <img src="/images/notfier_n8n_config_msg.gif" alt="Configuring Notifier credentials" />
    </Frame>  
  </Step>
  ...
  <Step title="Test and activate your workflow">
    ...
    <Check>
      Congratulations! Your Notifier and n8n inteYour automated messaging workflow is now operational! Whenever your trigger conditions are met, n8n will automatically send WhatsApp messages through Notifier.
    </Check>
  </Step>
</Steps>
