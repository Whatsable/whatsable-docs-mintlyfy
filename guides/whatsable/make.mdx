...
<Frame caption="Automate your WhatsApp messaging workflows with Make and WhatsAble">
  <img src="/images/whatsable_make_svg.svg" className="rounded-xl" />
</Frame>

<Info>
  WhatsAble lets you automate WhatsApp messaging through your favorite workflow automation platforms. This guide walks you through connecting WhatsAble with Make to create powerful WhatsApp messaging workflows.
</Info>
...
Now that you have WhatsAble set up, let's connect it to Make to automate your workflows.

<Steps>
  <Step title="Set up your Make Zaps">
    1. Log in to your Make account
    2. Create a new workflow by clicking **+ Create a new scenario**
    ...
    <Frame caption="Setting up Make module">
      <img src="/images/whatsable_make1.gif" alt="Setting up Make module" />
    </Frame>
  </Step>
  
  <Step title="Add the WhatsAble module">
    1. Click the **+** button to add a new module
    2. Search for "WhatsAble" in the apps or modules library
  ...
  <Step title="Test and activate your workflow">
    ...
    4. Click **Save** icon in the bottom-left corner to save your scenario (You can also set timer intarval for the workflow)
    5. Toggle the **Active** switch in the bottom-left corner with time to activate your workflow
    <Frame caption="Testing and activating your workflow">
      <img src="/images/whatsable_make5.gif" alt="Testing and activating your workflow" />
    </Frame>
  </Step>
</Steps>
...
<Frame caption="Sample WhatsAble Make Workflow">
  ```mermaid
  flowchart LR
