...
Now that you have NotNotifyer Systemifier set up, let's connect it to Make to automate your scenarios.
...
<Steps>
  ...
  <Step title="Add the Notifyer System module">
    ...
    <Frame caption="Adding the Notifyer System module">
      <img src=" " alt="Adding the Notifyer System module" />
    </Frame>
  </Step>
  
  <Step title="Configure Notifyer System credentials">
    <Accordion title="Credential Setup" defaultOpen>
      1. Once you click on Notifyer System module, select **Send a WhatsApp Message** from the **ACTIONS**
