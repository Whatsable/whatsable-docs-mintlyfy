...
<Frame caption="Connect your WhatsApp Business account to unlock powerful automated messaging">
  <iframe className="w-full aspect-video" src="https://www.youtube.com/embed/OTdN8bdP0bw" title="WhatsApp Business Integration" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
</Frame>
...
<Warning>
  Coexistence applies to the **WhatsApp Business app**. You do **not** delete that app to work with Notifyer. If the number is on the consumer WhatsApp app instead, migrate it to WhatsApp Business or use a different number.
</Warning>
